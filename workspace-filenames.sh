...
echo "Reading MC image"
fn_img_4d=$WDIR/img4d.nii.gz
#c4d -mcs $fn_img -tile w -o $fn_img_4d
echo "4D image written"
...
sc=$(itksnap-wt -P -i $WS -registry-get Layers.Layer[${tag_img_rot}].LayerMetaData.DisplayMapping.SelectedComponent)
echo $sc

fn_img_rot=$WDIR/img_rot.nii.gz
c4d $fn_img_4d -slice w $sc -o $fn_img_rot
